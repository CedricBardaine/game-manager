...
export var games: Game[] = [
        ...
        },
      {
        ...
        {
            nom: 'Counter-Strike: Source' ,
            type: 'fps' ,
            image: 'https://images.sftcdn.net/images/t_app-cover-l,f_auto/p/d15a13fa-96d3-11e6-9061-00163ec9f5fa/1042909916/garrys-mod-murder-screenshot.jpg' ,
             note: 6 ,
             description: "You shoot." ,
